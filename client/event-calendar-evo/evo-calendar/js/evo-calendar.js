...
;(function(factory) {
    ...
    EvoCalendar = (function() {
        ...
        function EvoCalendar(element, settings) {
            ...
            _.initials = {
                ...
                dates: {
                    ...
                    ru: {
                        ...
                        closeSidebarText: "Закрыть список",
            ...
            let selectedDateSplited = selectedDate.split('/')
            let activeMonth = +selectedDateSplited[0] - 1;
            let activeYear = selectedDateSplited[2];

            _.$active = {
                month: activeMonth,
                year: activeYear,
                date: _.options.selectedDate,
                event_date: _.options.selectedDate,
                events: []
            }
    ...
    EvoCalendar.prototype.buildTheBones = function() {
        ...
        if (!_.$elements.calendarEl.html()) {
            ...
            markup = '<div class="calendar-sidebar">'+
                        `<div class="calendar-month" onclick="$('#sidebarToggler').click();">`+
                        // `<button class="icon-button" role="button" class="changeMonthButton" onclick="$('#sidebarToggler').click();">`+
            ...
            markup += '<div class="calendar-events">'+
                            ...
                            "<button class='buttonAddEvent commonButton' onclick='addEvent()'>Добавить запись</button>" +
                        '</div>';
            ...
            // if: _.options.sidebarToggler
            if(_.options.sidebarToggler) {
                $(_.$elements.sidebarEl).append('<span id="sidebarToggler" style="display:none" role="button" aria-pressed title="'+_.initials.dates[_.options.language].closeSidebarText+'"><button class="icon-button"><span class="bars"></span></button></span>');
    ...
    EvoCalendar.prototype.buildEventList = function() {
        ...
        if ($('.calendar-active').length == 0) {
            $('.calendar-today').addClass('calendar-active');
        }
    }
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        markup += `<div class="event-icon"><div class="iconDeleteRed" role="button" onclick="deleteEvent(this.parentNode.parentNode.getAttribute('data-event-index'));">`;
        // if (event_data.color) {
        //     markup += 'style="background-color:'+event_data.color+'"'
        // }
        markup += '</div></div><div class="event-info" data-event-index="'+(event_data.id)+'" onclick="toClientPage(this.getAttribute(`data-event-index`));"><p class="event-title">'+ event_data.name;
    ...
    EvoCalendar.prototype.buildCalendar = function() {
        ...
        _.$elements.sidebarEl.find('.calendar-month > p').text(title);
    ...
    ****************/
    ...
    EvoCalendar.prototype.selectYear = function(event) {
        ...
        $('.event-header > p, .event-list').empty();
        $('.buttonAddEvent').replaceWith('');
    ...
    EvoCalendar.prototype.selectDate = function(event) {
        ...
        $('.buttonAddEvent').replaceWith('');
        $('.calendar-events').append("<button class='buttonAddEvent commonButton' onclick='addEvent()'>Добавить запись</button>");
    };
